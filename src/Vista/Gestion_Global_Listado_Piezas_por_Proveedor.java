...
public class Gestion_Global_Listado_Piezas_por_Proveedor extends JFrame {
	 ...
	 */
	public Gestion_Global_Listado_Piezas_por_Proveedor() throws ClassNotFoundException, SQLException {
		...
		JLabel lblNewLabel = new JLabel("LISTADO DE RELACIONES PIEZAS-PROVEEDORES-PROYECTO");
		...
		Bd.llenarListaRelaciones(table,modelo);
