...
public class Piezas_Consulta extends JFrame {
	 ...
	 */
	public Piezas_Consulta() throws ClassNotFoundException, SQLException {
		...
		cTipo.setModel(new DefaultComboBoxModel(new String[] {"Todos", "xCodigo", "xNombre", "xPrecio", "xDescripción"}));
		GroupLayout gl_contentPane = new GroupLayout(contentPane);
